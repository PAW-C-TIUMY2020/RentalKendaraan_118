...
namespace RentalKendaraan_NIM.Controllers
{
    public class KendaraansController : Controller
    {
        ...
        {
            ViewData["IdKendaraan"] = new SelectList(_context.JenisKendaraan, "IdJenisKendaraan", "NamaJenisKendaraan");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdKendaraan,NamaKendaraan,NoPolisi,NoStnk,IdJenisKendaraan,Ketersediaan")] Kendaraan kendaraan)
        {
            ...
            ViewData["IdKendaraan"] = new SelectList(_context.JenisKendaraan, "IdJenisKendaraan", "NamaJenisKendaraan", kendaraan.IdKendaraan);
            return View(kendaraan);
        }
